...
require (
	github.com/stellar/go v0.0.0-20250322075617-5ccaef04a539 // For xdr types if needed, and support/errors
...
replace github.com/stellar/ttp-processor/server => ./server

// Add this line to tell Go to use your local code instead of fetching from GitHub
...
replace github.com/withObsrvr/ttp-processor/gen/event_service => ./gen/event_service

replace github.com/withObsrvr/ttp-processor/server => ./server
