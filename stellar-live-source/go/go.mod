...
require (
	github.com/stellar/go v0.0.0-20251210100531-aab2ea4aca88 // indirect; For xdr types if needed, and support/errors
...
require github.com/withobsrvr/flowctl v0.0.4
