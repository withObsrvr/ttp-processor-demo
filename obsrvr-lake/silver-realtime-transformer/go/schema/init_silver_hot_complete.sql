...
-- Table: smart_account_context_rules
-- Current OpenZeppelin smart-account context-rule state derived from contract events.
...
-- Table: smart_account_signers
-- Current smart-account signer registry and rule assignment state.
...
-- Table: smart_account_policies
-- Current smart-account policy registry and rule assignment state.
