module github.com/withObsrvr/obsrvr-lake-unified-silver-processor

go 1.25.4

require (
	github.com/duckdb/duckdb-go/v2 v2.10501.0
	github.com/withObsrvr/obsrvr-lake-unified-processor v0.0.0
...
replace github.com/withObsrvr/obsrvr-lake-unified-processor => ../../obsrvr-lake-unified-processor/go
