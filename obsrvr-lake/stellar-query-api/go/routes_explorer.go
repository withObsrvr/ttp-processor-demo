...
func (app *application) registerExplorerRoutes(router *mux.Router) {
	...
	router.HandleFunc("/api/v1/silver/smart-accounts/lookup/credential/{credential_id}", smartWalletHandlers.HandleSmartAccountLookupByCredential).Methods("GET")
	router.HandleFunc("/api/v1/silver/smart-accounts/lookup/address/{address}", smartWalletHandlers.HandleSmartAccountLookupByAddress).Methods("GET")
	router.HandleFunc("/api/v1/silver/smart-accounts/stats", smartWalletHandlers.HandleSmartAccountStats).Methods("GET")
	router.HandleFunc("/api/v1/silver/smart-accounts/{contract_id}/rules", smartWalletHandlers.HandleSmartAccountState).Methods("GET")
