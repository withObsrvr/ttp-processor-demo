...
// Replace for local protobuf generation
replace github.com/withobsrvr/contract-invocation-processor/gen/contract_invocation => ./gen/contract_invocation

replace github.com/withobsrvr/contract-invocation-processor/gen/contract_invocation_service => ./gen/contract_invocation_service

// Use Protocol 23 branch for Protocol 23 specific features
// This provides access to:
// - ContractIdPreimageTypeContractIdFromSourceAccount
// - ContractIdPreimageTypeContractIdFromAddress
// - LedgerCloseMetaV2.EvictedTemporaryLedgerKeys
// - LedgerCloseMetaV2.EvictedPersistentLedgerEntries
// - Updated TransactionMeta structures
replace github.com/stellar/go => github.com/stellar/go v0.0.0-20250716214416-01d16bf8185f // protocol-23 branch
